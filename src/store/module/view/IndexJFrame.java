...
import store.framework.util.ImagePanel;
import store.framework.util.MyFont;
import store.framework.util.WindowOpacity;
...
public class IndexJFrame extends JFrame implements MouseListener, ActionListener {
	...
	public void initTopMenu() {
		...
		String[] nameStrings = { "首页", "商品库存", "进销存管理", "用户管理" };
	...
	public void mouseClicked(MouseEvent e) {
		if (e.getSource() == home) {
			...
			creatHome();
			home.setText("<html><font color='#336699' style='font-weight:bold'>" + "首页" + "</font>&nbsp;</html>");
			baseData.setText("<html><font color='black'>" + "商品库存" + "</font>&nbsp;</html>");
			...
			sign_baseData = 1;
			creatBaseDataTab();
			baseData.setText("<html><font color='#336699' style='font-weight:bold'>" + "商品库存" + "</font>&nbsp;</html>");
